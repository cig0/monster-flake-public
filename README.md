...
- **Declarative, idempotent Homebrew & Flatpak management**
...
- Populate the skeleton files manually, via `sops`/`agenix`, or by piping environment variables before building
