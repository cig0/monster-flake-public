...
/*
  ...
  TODO: deprecate this workaround with NixOS 25.11 as it already includes this fix.
*/
self: super:
let
  # myFlakeDir = "${config.myNixos.myOptions.flakeSrcPath};";
  myFlakeDir = "/home/cig0/workdir/cig0/monster-flake";
